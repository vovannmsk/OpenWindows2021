...
namespace OpenGEWindows
{
    ...
    public class ServerAmerica2 : Server
    {
        ...
        public ServerAmerica2(botWindow botwindow)
        {
            ...
            this.pointisBarack1 = new PointColor(65 - 5 + xx, 153 - 5 + yy, 2400000, 5);            //зеленый цвет в слове Barracks 
            this.pointisBarack2 = new PointColor(65 - 5 + xx, 154 - 5 + yy, 2400000, 5);            //
            this.pointisBarack3 = new PointColor(36 - 5 + xx, 56 - 5 + yy, 15500000, 5);            // Barrack Mode
            this.pointisBarack4 = new PointColor(36 - 5 + xx, 57 - 5 + yy, 15100000, 5);            //
