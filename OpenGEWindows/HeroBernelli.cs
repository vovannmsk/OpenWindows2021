...
namespace OpenGEWindows
{
    public class HeroBernelli : Hero
    {
        ...
        public HeroBernelli(int i, int xx, int yy)
        {
            ...
            pointBuff11 = new PointColor(89 - 5 + xx, 596 - 5 + yy, 13133369, 0);
            pointBuff12 = new PointColor(89 - 5 + xx, 597 - 5 + yy, 13067318, 0);
            pointBuff21 = new PointColor(80 - 5 + xx, 589 - 5 + yy, 6319302, 0);
            pointBuff22 = new PointColor(81 - 5 + xx, 589 - 5 + yy, 5858504, 0);
            heroName = "Bernelli";
        }
