...
{
    public class SingTownCoimbra : Town
    {
        ...
        public SingTownCoimbra(botWindow botwindow)
        {
...
//            this.pointHeadTrader = new Point(91 - 5 + xx, 182 - 5 + yy);                     //голова торговца          //проверено
            ...
            this.pointBookmark1 = new PointColor(874 - 5 + xx, 41 - 5 + yy, 7700000, 5);       //проверено
            this.pointBookmark2 = new PointColor(875 - 5 + xx, 41 - 5 + yy, 7700000, 5);       //проверено
