...
namespace States
{
    public class StateGT402 : IState
    {
        ...
        public StateGT402(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        public IState StateNext()         // возвращает следующее состояние, если переход осуществился
        {
            ...
            {
                return new StateGT403(botwindow);             //если пет не призван и не активирован, то идем обычным порядком
            }
        }
