...
namespace States
{
    public class StateGT321 : IState
    {
        ...
        /// <summary>
        /// метод осуществляет действия для перехода из состояния GT0321 в GT06
        /// </summary>
        public void run()                // переход к следующему состоянию
        {
            server.OpenMapForState();   //открываем меню Alt+Z
        ...
        {
            return new StateGT322(botwindow);
        }
