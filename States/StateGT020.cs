...
namespace States
{
    public class StateGT020 : IState
    {
        ...
        public StateGT020(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        public IState StateNext()         // возвращает следующее состояние, если переход осуществился
        {
            ...
            {
                return new StateGT021(botwindow);             //если пет не активирован, то идем обычным порядком
            }
        }
