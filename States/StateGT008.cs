...
namespace States
{
    public class StateGT008 : IState
    {
        ...
        {
            return new StateGT009(botwindow);  //, gototrade);
        }
...
//            if ((server.isLogout()) || (!botwindow.isHwnd()))
            ...
            {
                return new StateGT012(botwindow);  //, gototrade);    //состояние из которого осуществляется End Programm
            }
        }
