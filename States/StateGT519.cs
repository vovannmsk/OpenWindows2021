...
namespace States
{
    public class StateGT519 : IState
    {
        ...
        public StateGT519(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGT520(botwindow);
        }
        ...
        {
            return new StateGT519(botwindow);
        }
