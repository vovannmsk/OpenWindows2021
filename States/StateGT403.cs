...
namespace States
{
    public class StateGT403 : IState
    {
        ...
        public StateGT403(botWindow botwindow)   //, GotoTrade gototrade)
        {
...
//            return ((!pet.isSummonPet()) || (pet.isActivePet()));
            return !pet.isSummonPet();                  //если пет не призван
        }
        ...
        {
            return new StateGT404(botwindow);             
        }
