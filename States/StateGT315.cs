...
namespace States
{
    public class StateGT315 : IState
    {
        ...
        public StateGT315(botWindow botwindow)   
        {
        ...
        {
            server.WriteToLogFileBH("Начало. Состояние 315");
            //result = this.botwindow.Connect(); 
        ...
        {
            return new StateGT316(botwindow);
        }
