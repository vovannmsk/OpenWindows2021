...
namespace States
{
    public class StateGT050 : IState
    {
        ...
        public StateGT050(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGT051(botwindow);
        }
        ...
        public IState StatePrev()         // возвращает запасное состояние, если переход не осуществился
        {
            ...
            else
            {
                ...
                else { return new StateGT058(botwindow); }           // если кто-то из героев убит присваиваем конечное состояние, а именно GT01, чтобы на следующем круге реанимировать бота
            }
        }
