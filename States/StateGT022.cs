...
namespace States
{
    public class StateGT022 : IState
    {
        ...
        public StateGT022(botWindow botwindow)   //, GotoTrade gototrade)
        {
        ...
        {
            return new StateGT023(botwindow);
        }
        ...
        public IState StatePrev()         // возвращает запасное состояние, если переход не осуществился
        {
            ...
            else
            {
                ...
                else { return new StateGT001(botwindow); }           // если кто-то из героев убит, то присваиваем конечное состояние, а именно GT01, чтобы на следующем круге реанимировать бота
            }
        }
