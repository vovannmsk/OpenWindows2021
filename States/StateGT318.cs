...
namespace States
{
    public class StateGT318 : IState
    {
        ...
        public StateGT318(botWindow botwindow)
        {
            this.botwindow = botwindow;
            ServerFactory serverFactory = new ServerFactory(botwindow);
            this.server = serverFactory.create();   // создали конкретный экземпляр класса server по паттерну "простая Фабрика" (Америка, Европа или Синг)
            this.tekStateInt = 318;
        }
        ...
        {
            server.systemMenu(1, true);   //открываем меню с выбором каналов. 
        ...
        {
            return server.isOpenMenuChooseChannel();     // проверяем, открыто ли меню с выбором канала
        }
        ...
        {
            return new StateGT319(botwindow);
        }
