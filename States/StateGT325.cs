...
namespace States
{
    public class StateGT325 : IState
    {
        ...
        public StateGT325(botWindow botwindow)
        {
        ...
        {
            return new StateGT326(botwindow);
        }
        ...
        {
            return new StateGT330(botwindow); // если оказались не в диалоге, в в городе, то значит какашки закончились и идём в конец цикла
        }
